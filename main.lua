...
if IsMobile then 
    ...
    ImageLabel.Image = "rbxassetid://17151235079"
...
local Window =
    ...
    {
        Title = "Kakah Menu",
        SubTitle = "developed by souza[CRACKED BY SKINNY AND ZV_YZ]",
        TabWidth = 160,
...
function Window:NewTab(mmb)
    ...
    function newmm:NewParagraph(cf)
        local paragraphnew
        newTitle = cf.Title or "Kakah Menu"
        ...
        function paragraphnew:Set(cf2)
            newTitle = cf2.Title or "Kakah Menu"
...
function SaveSettings2()
    ...
    if not isfolder("Kakah Menu") then
        makefolder("Kakah Menu")
    end
    writefile("Kakah Menu/" .. SaveFileName2, HttpService:JSONEncode(Settings2))
end
...
function ReadSetting2()
    local s, e =
        ...
        function()
            ...
            return HttpService:JSONDecode(readfile("Kakah Menu/" .. SaveFileName2))
        end
    )
    if s then
        return e
...
do
    DefaultTab:AddSection("Ping Poing")
    ...
    FarmTab:NewParagraph(
        {
            Title = "Farm Note",
            Content = "Se você escolher 2 Opção como  Auto Farm Nível e Cake Prince, então quando o nível máximo ele vai fazer Cake Prince"
        }
    )
