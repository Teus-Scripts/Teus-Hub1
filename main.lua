...
wait(0.2)
	game.StarterGui:SetCore("SendNotification", {
		Title = "Mon Notification", 
		Text = "Wellcome to Mon Hub Kaitun Script",
		Icon = "http://www.roblox.com/asset/?id=14334760790",
		Duration = 2
	})
	wait(0.1)
...
local library = {
	WorkspaceName = "Mon KAITAN SERISE 2024🎉",
	flags = {},
	signals = {},
	objects = {},
	elements = {},
...
local PepsiUi = library:CreateWindow({
    Name = "Mon Hub Kaitan Sereis 2024",
    Theme = {
        Image = "rbxassetid://7483871523",
        Info = "Mon Hub Kaitan Sereis 2024",
        Background = {
