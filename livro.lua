...
local L_4_ = L_1_:CreateWindow({
    Title = "ᴄᴀᴛ ʜᴜʙ ┇ ʙʟᴏx ꜰʀᴜɪᴛꜱ",
    SubTitle = "ꜰʀᴇᴇ ᴠᴇʀꜱɪᴏɴ | ʙʏ: ǫᴜʏ́",
    TabWidth = 160,
...
---------Near Mas
  ...
  --v.Humanoid:ChangeState(14)
	...
	if Third_Sea then
		local L_394_ = L_5_.Seaevent:AddSection("🦊 Kitsune 🦊")
		local L_395_ = L_5_.Seaevent:AddToggle("ToggleEspKitsune", {
		...
		local L_396_ = L_5_.Seaevent:AddToggle("ToggleTPKitsune", {
		...
		local L_397_ = L_5_.Seaevent:AddToggle("ToggleCollectAzure", {
	...
	if Third_Sea then
		local L_409_ = L_5_.Seaevent:AddSection("Rough Sea")
		local L_410_ = L_5_.Seaevent:AddToggle("ToggleSailBoat", {
			Title = "Auto Buy Ship",
			Default = false
		})
		...
		local L_411_ = L_5_.Seaevent:AddToggle("ToggleTerrorshark", {
		...
		local L_412_ = L_5_.Seaevent:AddToggle("TogglePiranha", {
			Title = " Kill Piranha",
			Default = false
		})
		...
		local L_413_ = L_5_.Seaevent:AddToggle("ToggleShark", {
			Title = " Kill Shark",
			Default = false
		})
		...
		local L_414_ = L_5_.Seaevent:AddToggle("ToggleFishCrew", {
		...
		local L_415_ = L_5_.Seaevent:AddToggle("ToggleShip", {
			Title = "Kill Ship",
			Default = false
		})
		...
		local L_416_ = L_5_.Seaevent:AddToggle("ToggleGhostShip", {
