...
_G.NameHub = "by SonHFC101" -- ชื่อ Hub
...
_G.SelectWeapon = "Melee"
  AutoFarm:Dropdown("Select Weapons",{"Melee","Sword","Gun","Blox Fruit"},{"Melee"},function(v)
   ...
   AutoFarm:Toggle("Cày cấp độ",false,function(value)
    _G.AutoFarm = value
  ...
  AutoFarm:Toggle("Giết quái ở gần", false,function(value)
         _G.AutoNear = value
    ...
    while wait() do
     ...
     AutoFarm:Seperator("Cày thông thạo")       
...
spawn(function()
    while wait() do
      ...
      AutoFarm:Seperator("Auto Chest Farm")       
       ...
       AutoFarm:Toggle("Nhặt rương", false,function(value)
         _G.FarmChest = value 
    ...
    AutoFarm:Toggle("Nhặt berry", false,function(value)
...
spawn(function()
   ...
   if World3 then
    ...
    spawn(function()
     ...
     AutoFarm:Toggle("Cày xương", false,function(value)
         game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest")
     		_G.FarmBone = value 
    ...
    spawn(function()
        ...
        AutoFarm:Toggle("Triệu hồi boss lưỡi hái", false,function(value)         
     	_G.Hallow = value 
         StopTween(_G.Hallow)
       end)
    ...
    while wait() do
      ...
      AutoFarm:Toggle("Trao đổi xương", false,function(value)         
     		_G.Rdbone = value 
       end)
       ...
       spawn(function()
         ...
         AutoFarm:Toggle("Cầu nguyện", false,function(value)         
     		_G.Pray = value 
       end)
       ...
       spawn(function()
        ...
        AutoFarm:Toggle("Thử vận may", false,function(value)         
     		_G.Trylux = value 
       end)
       ...
       AutoFarm:Toggle("Đánh boss chim", false,function(value)         
     	_G.FarmDaiBan = value 
   ...
   CakePrinceStatus = AutoFarm:Label("Check Cake Prince")
    task.spawn(function()
      ...
      CakePrinceStatus:Set("Prince King Spawned ✅")
       ...
       AutoFarm:Toggle(Đánh quái", false,function(value)         
     	_G.FarmCake = value 
   ...
   local CakePos = CFrame.new(-2130.80712890625, 69.95634460449219, -12327.83984375)
    ...
    while task.wait() do
       ...
       AutoFarm:Toggle("Auto bột V2", false,function(value)         
   ...
   spawn(function()
	...
	AutoFarm:Toggle("Lấu cốc socola", false,function(value)         
     ...
     if World1 then
       _G.SelectBoss = "Vua khỉ"
       AutoFarm:Dropdown("Auto Select Boss",{"áo hồng", "Vua khỉ", "Bobby", "Yeti", "Mob Leader", "Vice Admiral", "Warden", "Chief Warden", "Swan", "Magma Admiral", "Fishman Lord", "Wysper", "Thunder God", "Cyborg", "Saber Expert"},{"The Gorilla King"},function(Value)
        _G.SelectBoss = Value
       end)
   	  elseif World2 then      
       _G.SelectBoss = "Boss kim cương"
       AutoFarm:Dropdown("Auto Select Boss",{"Boss kim cương", "Jeremy", "Fajita", "Don Swan", "Smoke Admiral", "Cursed Captain", "Darkbeard", "Order", "Awakened Ice Admiral", "Tide Keeper"},{"Diamond"},function(Value)
       _G.SelectBoss = Value
      end)      
     elseif World3 then      
       _G.SelectBoss = "boss cảng"
       AutoFarm:Dropdown("Auto Select Boss",{"boss cảng", "Island Empress", "Rocket Admiral", "Captain Elephant", "Beautiful Pirate", "rip_indra True Form", "Longma", "Soul Reaper", "Cake Queen", "Cake Prince", "Dough King"
    ...
    AutoFarm:Toggle("Đánh boss", false,function(value)         
      	_G.AutoBoss = value 
      ...
      AutoFarm:Seperator("Lấy nguyên liệu")
   ...
   spawn(function()
     ...
     if World2 then
      AutoFarm:Dropdown("Lấy nguyên liệu",{"Farm Leather + Scrap Metal","Farm Radiactive Material","Farm Magma Ore","Farm Vampire Fang","Farm Mystic Droplet","Farm Ectoplasm",},{"Farm Leather + Scrap Metal"},function(Value)
        _G.SelectMaterial = Value
      end)
...
PosY = 35            
  ...
  Settings:Toggle("Auto Haki Buso", true,function(value)
    ...
    while task.wait(0.1) do
     ...
     Settings:Toggle("Tự bật V3", false,function(value)    
      _G.AutoRaceV3 = value
    end)
  spawn(function()
    while wait() do
   ...
   Settings:Toggle("Tự bật V4", false,function(value)    
      _G.AutoRaceV4 = value
    end)
    spawn(function()
    while wait() do
...
PosY = 35
  ...
  Settings:Toggle("Dodge No CD", false,function(value)       
    ...
    Settings:Toggle("Infinite Jump", false,function(Cokka)       
     ...
     if World1 or World2  then
      ...
      if World1 then
      Items:Toggle("Sang biển 2", false,function(Second)   
    ...
    pcall(function()
        ...
        Items:Toggle("Sang biển 3", false,function(ThirdSea)      
    ...
    while wait() do
       ...
       Items:Toggle("Đánh hải tặc ở pháo đài", false,function(Values)      
	...
	while wait() do
     ...
     Items:Seperator("Đánh boss bí ẩn")
    ...
    while wait() do
     ...
     Items:Toggle("Đánh boss bí ẩn", false,function(Values)      
   ...
   Items:Seperator("Auto Boss Raid")
    ...
    if World1 then
     Items:Toggle("Đánh râu trắng", false,function(Values)      
          _G.Greybeard = Values
     ...
     if World2 then         
       Items:Toggle("Đánh râu đen", false,function(Values)
       ...
       Items:Toggle("Đánh boss tàu ma", false,function(Values)      
	...
	while wait() do
        ...
        Items:Toggle("Đánh rip", false,function(Values)      
    ...
    local AdminPos = CFrame.new(-5344.822265625, 423.98541259766, -2725.0930175781)
     spawn(function()
        ...
        Items:Seperator("Lấy công thức haki có trong sever")
        
        Items:Toggle("Lấy công thức haki có trong sever", false,function(Value) 
 ...
 if World3 then
       Items:Seperator("Mua kiếm huyền thoại")
         
       Items:Toggle("Lấy yama", false,function(Values) 
          _G.AutoYama = Values
        end)
       ...
       spawn(function()
         ...
         Items:Toggle("Lấy tushita", false,function(Values) 
...
RunService.RenderStepped:Connect(function()
    ...
    if prehistoricIsland then
      ...
      Volcano:Toggle("Tìm đảo núi lửa false, function(value)
          _G.Nocliprock = value
...
spawn(function()
  ...
  Volcano:Toggle("Bay đến đảo", false, function(value)
...
spawn(function()
  ...
  Volcano:Toggle("Dùng võ", false, function(value)
      _G.UseMelee = value
  end)
  
  Volcano:Toggle("Dùng kiếm", false, function(value)
      _G.UseSword = value
  end)
  
  Volcano:Toggle("Dùng súng, false, function(value)
      _G.UseGun = value
  end)

  Volcano:Toggle("Giết quái ở đảo", false, function(value)
      _G.KillGolem = value
...
Volcano:Toggle("kill quái", false, function(value)
      _G.Kill_Aura = value
  end)
  ...
  Kitsune = Events:Label("Check Kitsune island")
   ...
   spawn(function()
	...
	spawn(function()
     ...
     Events:Toggle("Tự động nhặt lửa", false, function(value)
...
spawn(function()
    ...
    Events:Toggle("Đánh cá to",false, function(state)
...
while wait() do 
 ...
 spawn(function()
    ...
    Events:Toggle("Đánh cá con",false, function(state)
        _G.KillShark = state
    ...
    Events:Toggle("Đánh tàu",false, function(state)
    ...
    Events:Toggle("Auto Auto Kill Fish Crew Member",false, function(state)
      ...
      Events:Toggle("Định vị đảo bí ẩn", false, function(value)
  ...
  local virtualInputManager = game:GetService("VirtualInputManager")
   spawn(function()
    ...
    Events:Toggle("Nhặt bánh răng",false, function(state)
        _G.TweenMGear = state
