...
Main:Toggle("Auto Kaitan",false,function(value)
    ...
    local Select_M = Main:Dropdown("Select Mob",Mons,function(value)
        _G.SelectMob = value
    end)
    
    Main:Button("Refresh Mob",function()
     Select_M:Clear()
     local xx = {}
...
Main:Toggle("Auto Farm Chest Hop",_G.AutoFarmChest_Hop,function(value)
    ...
    local BossName = Main:Dropdown("Select Bosses",_G.SelectBoss,function(value)
        _G.SelectBoss = value
    end)
...
spawn(function()
    ...
    M:Button("Teleport To Gear",false,function(value)
...
M:Toggle("Auto Tushita", _G.Autotushita,function(value)
 ...
 M:Toggle("Auto KoKo Sword (New !)", _G.AutoOderSword,function(value)
    ...
    M:Seperator("Sea Baest")
    
M:Toggle("Auto Farm Sea baest",false,function(value)
...
M:Toggle("Auto Farm Sea baest Hop",false,function(value)
_G.AutoFarmSeabaestHop = value
end)

spawn(function()
    pcall(function()
        while wait() do
            if (_G.AutoFarmSeabaestHop and _G.AutoFarmSeabaest) then
                Hop()
            end
        end
    end)
...
Esp:Toggle("Esp Sea Beast", false, function(nec)
    SeaESP = nec
end)
spawn(function()
    while wait() do
...
Esp:Toggle("Esp Mob", false, function(nec)
    MobESP = nec
end)
spawn(function()
    while wait() do
