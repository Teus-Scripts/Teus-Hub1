    ...
    embeds = {
        {
            ...
            footer = {
                text = "Time: " .. os.date("%Y-%m-%d %H:%M:%S VN"),
                icon_url = ""
            },
            fields = {
                {
...
if g then
    ...
    local v = Enum.ButtonStyle.RobloxButton
        ...
        u.Image = "rbxassetid://17466928754"
...
local Window = Quantum:CreateWindow({
    Title = "<font color='rgb(65, 22, 240)'>Quantum Hub </font>",
    SubTitle = "<font color='rgb(0, 240, 156)'>NEW GENERATION BETA</font>",
    TabWidth = 160,
...
local Sub = Window:AddTab({Title = "Sub Farm", Icon = "swords"})
...
local AutoKillRipIndra = Sub:AddToggle("AutoKillRipIndra", {
    Title = "Auto Rip Indra [True Form]",
    Description = "",
    Default = false,
    Callback = function(value)
