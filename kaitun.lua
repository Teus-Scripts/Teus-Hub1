...
local AlchemyNotify = function(Text_i,Duration_i)
    game.StarterGui:SetCore("SendNotification", {
        ...
        Text = Text_i,
        Duration = Duration_i,
        Icon = "rbxassetid://135962226963180"
    })
end
--Key
wait(0.1)
AlchemyNotify("ขอบคุณที่ใช้ SHIN X HUB!",5)
wait(0.1)
AlchemyNotify("ยูทูป : SHIN X HUB",5)
wait(0.5)
local Notification = require(game:GetService("ReplicatedStorage").Notification)
Notification.new("<Color=Cyan>ขอบคุณที่ใช้สคริปต์ SHIN X HUB<Color=/>"):Display()
wait(0.5)
Notification.new("<Color=Yellow>SHIN X HUN เวอร์ชั่น 2.01<Color=/>"):Display()
wait(1)
repeat
    wait()
...
local HomePage = a:Tab("เกี่ยวข้อง", "rbxassetid://135962226963180")
local Main = a:Tab("เมนู", "rbxassetid://15712703260")
local Set = a:Tab("ตั้งค่า", "rbxassetid://15712711639")
local Farm = a:Tab("ฟาร์มอื่นๆ", "rbxassetid://15712717270")
...
HomePage:Label("แมพ Blox Fruit | เวอร์ชั่น 2.01 | สถานะ 🟢")
...
HomePage:Label("ติดตามข่าวสาร และ การอัพเดทได้ที่")
HomePage:Button("คัดลอกลิ้งยูทูป", function()
    AlchemyNotify("คัดลอกลิ้งยูทูป",5)
...
Main:Dropdown("โหมดการฟาร์ม", {"Quest","No Quest"}, function(value)
    FarmMode = value
end)
FarmMode = FarmMode or "Quest"

Main:Toggle("เริ่มการฟาร์ม", false, function(value)
    _G.AutoFarm = value
...
if World1 then
    Main:Toggle("ออโต้ ฟาร์ม เร็ว [1 -> 300]", false, function(value)
        _G.Farmfast = value
...
Main:Toggle("ออโต้ ฟาร์ม มอนรอบๆ", false, function(value)
...
Main:Toggle("ออโต้ คาตาคุริ V2", false, function(value)
...
spawn(function()
    while wait() do
        pcall(function()
            BoneCheck:Set("คุณมีโบนอยู่ : "..(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Bones","Check")))
        end)
    end
end)
...
Main:Toggle("สุ่มโบน", false, function(value)
...
Main:Toggle("ออโต้ Pray", false, function(value)
    _G.Pray = value
end)
spawn(function()
    pcall(function()
...
Main:Toggle("ออโต้ Try Luck", false, function(value)
    _G.Trylux = value
end)
spawn(function()
    pcall(function()
...
Main:Seperator("ความชำนาญ")

Main:Toggle("ออโต้ ความชำนาญ ผลปีศาจ", false, function(value)
...
Main:Toggle("ออโต้ ความชำนาญ ปืน", false, function(value)
...
Main:Toggle("ออโต้ ความชำนาญ ดาบ", false, function(value)
...
Main:Slider("เวลาในการใช้  สกิว", 0, 100, 30, function(value)
    _G.Kill_At = value
end)
_G.Kill_At = 30
...
Main:Button("รีเซ็ตบอส", function()
    BossName:Clear()
    wait(0.1)
    for i, v in pairs(game:GetService("ReplicatedStorage"):GetChildren()) do
...
Main:Toggle("ออโต้ ฟาร์ม บอส ที่เลือก", false, function(value)
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest")
...
Main:Toggle("ออโต้ ฟาร์ม บอส ทั้งหมด", false, function(value)
...
Main:Dropdown("เลือกมอนสเตอร์", tableMon, function(value)
    _G.SelectMob = value
end)

Main:Toggle("ออโต้ ฟาร์ม มอนสเตอร์ ที่เลือก", false, function(value)
...
-----------------------------------------------------------------------------------------------------------------------------Setting Tab
Set:Toggle("ออโต้ คลิ๊ก", false, function(value)
    _G.AutoClick = value
end)
...
Set:Toggle("ลบมอนสเตอร์", false, function(value)
    _G.inv = value
    while wait() do
        if _G.inv then
            pcall(function()
...
Set:Toggle("ปิดการแจ้งเตือน", false, function(value)
...
Set:Toggle("ลบเอฟเฟกต์ความตาย", true, function(value)
...
Set:Toggle("ความเร็วโจม", true, function(value)
    _G.FastAttack = value
end)
--Fast Attack Delta
...
Set:Slider("ระยะ ฟาร์ม", 0, 50, 35, function(value)
    PosY = value
end)
PosX = 1
PosY = 35
...
Farm:Toggle("ออโต้ โรงงาน", false, function(value)
...
Farm:Toggle("ออโต้ โจรสลัดบุก", false, function(value)
    _G.RaidPirate = value
...
Farm:Toggle("ออโต้ กีต้า", false, function(value)
...
Farm:Toggle("ออโต้ Kill White Beard", false, function(value)
    _G.Autogay = value
...
Farm:Toggle("ออโต้ ทำ เผ่า V2", false, function(value)
...
Farm:Toggle("ออโต้ บาร์ติโล เควสต์", false, function(value)
...
spawn(function()
    while wait() do
        pcall(function()
            ObservationRange:Set("ฮาคิสังเกตของมึงตอนนี้เลเวล : "..math.floor(game:GetService("Players").LocalPlayer.VisionRadius.Value))
        end)
    end
end)
    ...
    pcall(function()
        while wait() do
            if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("LegendarySwordDealer", "1") then
                LegendSwords:Set("ดาบชิซุย 🟢")
            elseif game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("LegendarySwordDealer","2") then
                LegendSwords:Set("ดาบวาโด 🟢")
            elseif game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("LegendarySwordDealer","3") then
                LegendSwords:Set("ดาบซาดดี้ 🟢")
            else
                LegendSwords:Set("คนขายดาบ 🔴")
            end
        end
    end)
end)

Farm:Toggle("ออโต้ ซื้อดาบหายาก", false, function(value)
