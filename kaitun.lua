...
MODILEMAGE.Image = "rbxassetid://10509313657"
...
local Library = Update:Window("RGB UI","https://www.roblox.com/headshot-thumbnail/image?userId="..game.Players.LocalPlayer.UserId.."&width=420&height=420&format=png",Enum.KeyCode.RightControl);
 Main3 = Library:Tab("MainFarm")
Main = Library:Tab("M")

    Main3:Seperator("MainFarm")
...
Main3:Toggle("AutoFarm Level",_G.AutoFarm,function(value)
        ...
        while wait() do
            pcall(function()
                if string.len(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")) == 88 then
                    MobKilled:Set("Boss 7Ã4 kill Defeat : "..string.sub(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner"),39,41))
                elseif string.len(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")) == 87 then
                    MobKilled:Set("Boss 7Ã4 kill Defeat : "..string.sub(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner"),39,40))
                elseif string.len(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")) == 86 then
                    MobKilled:Set("Boss 7Ã4 kill Defeat : "..string.sub(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner"),39,39))
                else
                    MobKilled:Set("Boss : 7¼3")
                end
            end)
        end
    end)
    ...
    spawn(function()
        ...
        Main3:Seperator("Candy")

Main3:Toggle("Auto Farm CD",_G.CD,function(value)
    _G.CD = value
    StopTween(_G.CD)
end)
            ...
            if _G.CD and W3 then
                pcall(function()
                    if game:GetService("Workspace").Enemies:FindFirstChild("Candy Pirate [Lv. 2400]") or game:GetService("Workspace").Enemies:FindFirstChild("Snow Demon [Lv. 2425]") then
                        for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if v.Name == "Candy Pirate [Lv. 2400]" or v.Name == "Snow Demon [Lv. 2425]" or v.Name then
                                if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                    repeat task.wait()
                                        AutoHaki()
                                        EquipWeapon(_G.SelectWeapon)
                                        ...
                                        game:GetService("VirtualUser"):CaptureController()
                                        game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
                                    until not _G.CD or not v.Parent or v.Humanoid.Health <= 0
                                end
                            end
                        end
                    else
    ...
    Main3:Seperator("Bone")
    
    local BoneFarm = Main3:Toggle("Auto Farm Bone",_G.Auto_Bone,function(value)
        _G.Auto_Bone = value
    ...
    Main3:Toggle("Auto Random Surprise",_G.Auto_Random_Bone,function(value)
    ...
    spawn(function()
        ...
        Main3:Button("Checking Bone", function()
...
_G.AutoRejoin = true
    ...
    Main3:Toggle("AutoRejoin",true,function(value)
         _G.AutoRejoin = value
end)
...
spawn(function()
    while wait(.1) do
        ...
        Main3:Toggle("White Screen",true,function(value)
...
Main3:Toggle("Fast Attack[1]",true,function(Fast)
    _G.FastAttack = Fast
end)
...
spawn(function()
    ...
    Main3:Toggle("Fast Attack[2]",false,function(value)
...
spawn(function()
    ...
    Main3:Toggle("Fast Attack[3]",false,function(value)
...
Main3:Button("Headless",function()
    ...
    Main3:Toggle("Delete Deaths EF",true,function(Death)
_G.Deaths = Death
while _G.Deaths do wait()
    pcall(function()
        repeat wait()
            game:GetService("ReplicatedStorage").Effect.Container.Death:Destroy()
        until not 
game:GetService("ReplicatedStorage").Effect.Container:FindFirstChild("Death")
    end)
end
end)
