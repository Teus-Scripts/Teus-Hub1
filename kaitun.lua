...
DiscordLib:Notification("Thông Báo" , "Hack Nhìu Lên Ko Bay Acc Đâu :>" , 10 ,11816162894 )
 ...
 _G.Color = Color3.fromRGB(74,224,224)
 ...
 Name.Text = text
 Name.TextColor3 = Color3.fromRGB(116, 255, 192)
 ...
 Hub.Text = "Cracking"
 Hub.TextColor3 = Color3.fromRGB(93, 255, 223)
 Hub.TextSize = 16.000
...
--------------------------------------------------------------------
local Library = Update:Window("Mango Man ","")
------------------------------------------
...
spawn(function()
 game:GetService("RunService").Heartbeat:Connect(function()
  pcall(function()
   for i,v in pairs(game:GetService("Workspace").s:GetChildren()) do
   if _G.Auto_Farm_Bone2 and StartMagnetBoneMon2 and (v.Name == "Ancient Zombie [Lv. 2000]" ) and (v.HumanoidRootPart.Position - PosMonBone.Position).magnitude <= 350 then
   v.HumanoidRootPart.CFrame = PosMonBone
   v.HumanoidRootPart.CanCollide = false
   v.HumanoidRootPart.Size = Vector3.new(50,50,50)
   if v.Humanoid:FindFirstChild("Animator") then
...
spawn(function()
 while wait() do
 if _G.Auto_Farm_Bone2 and World3 then
 pcall(function()
  if game:GetService("Workspace").Enemies:FindFirstChild("Ancient Zombie [Lv. 2000]")  then
  for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
  if v.Name == "Ancient Zombie [Lv. 2000]"  then
  if v.Humanoid.Health > 0 then
  repeat wait()
  AutoHaki()
  EquipWeapon(_G.Select_Weapon)
  ...
  game:GetService'VirtualUser':CaptureController()
  game:GetService'VirtualUser':Button1Down(Vector2.new(1280, 672))
  until _G.Auto_Farm_Bone2 == false or not v.Parent or v.Humanoid.Health <= 0
  end
  end
  end
  else
...
if _G.Select_Weapon1 == nil then
for i,v in pairs(game:GetService("Players").LocalPlayer.Backpack:GetChildren()) do
if v.ToolTip == "Melee" then
if game.Players.LocalPlayer.Backpack:FindFirstChild(tostring(v.Name)) then
_G.Select_Weapon1 = tostring(v.Name)
end
end
end
end
...
spawn(function()
 game:GetService("RunService").Heartbeat:Connect(function()
  pcall(function()
   for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
   if _G.Auto_Farm_Bone1 and StartMagnetBoneMon2 and (v.Name == "Flame Master [Lv. 1100]" ) and (v.HumanoidRootPart.Position - PosMonBone.Position).magnitude <= 350 then
   v.HumanoidRootPart.CFrame = PosMonBone
   v.HumanoidRootPart.CanCollide = false
   v.HumanoidRootPart.Size = Vector3.new(50,50,50)
   if v.Humanoid:FindFirstChild("Animator") then
...
spawn(function()
 while wait() do
 if _G.Auto_Farm_Bone1 and World3 then
 pcall(function()
  if game:GetService("Workspace").Enemies:FindFirstChild("Flame Master [Lv. 1100]")  then
  for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
  if v.Name == "Flame Master [Lv. 1100]"  then
  if v.Humanoid.Health > 0 then
  repeat wait()
  AutoHaki()
  EquipWeapon(_G.Select_Weapon1)
  StartMagnetBoneMon1 = true
  v.HumanoidRootPart.CanCollide = false
  v.HumanoidRootPart.Size = Vector3.new(60, 60, 60)
  PosMonBone = v.HumanoidRootPart.CFrame
  topos(v.HumanoidRootPart.CFrame * MethodFarm)
  game:GetService'VirtualUser':CaptureController()
  game:GetService'VirtualUser':Button1Down(Vector2.new(1280, 672))
  until _G.Auto_Farm_Bone1 == false or not v.Parent or v.Humanoid.Health <= 0
  end
  end
  end
  else
   StartMagnetBoneMon1 = false
  for i,v in pairs(game:GetService("ReplicatedStorage"):GetChildren()) do
  if v.Name == "Flame Master [Lv. 1100]" then
  topos(v.HumanoidRootPart.CFrame * MethodFarm)
...
spawn(function()
 game:GetService("RunService").Heartbeat:Connect(function()
  pcall(function()
   for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
   if _G.Auto_Farm_Bone1 and StartMagnetBoneMon2 and (v.Name == "Rumble Master [Lv. 1100]" ) and (v.HumanoidRootPart.Position - PosMonBone.Position).magnitude <= 350 then
   v.HumanoidRootPart.CFrame = PosMonBone
   v.HumanoidRootPart.CanCollide = false
   v.HumanoidRootPart.Size = Vector3.new(50,50,50)
   if v.Humanoid:FindFirstChild("Animator") then
...
spawn(function()
 ...
 if _G.Auto_Farm_Bone1 and World3 then
 pcall(function()
  if game:GetService("Workspace").Enemies:FindFirstChild("Rumble Master [Lv. 1100]")  then
  for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
  if v.Name == "Rumble Master [Lv. 1100]"  then
  if v.Humanoid.Health > 0 then
  repeat wait()
  AutoHaki()
  EquipWeapon(_G.Select_Weapon1)
...
spawn(function()
 game:GetService("RunService").Heartbeat:Connect(function()
  pcall(function()
   for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
   if _G.Auto_Farm_Bone1 and StartMagnetBoneMon2 and (v.Name == "Light Master [Lv. 1100]" ) and (v.HumanoidRootPart.Position - PosMonBone.Position).magnitude <= 350 then
   v.HumanoidRootPart.CFrame = PosMonBone
   v.HumanoidRootPart.CanCollide = false
   v.HumanoidRootPart.Size = Vector3.new(50,50,50)
   if v.Humanoid:FindFirstChild("Animator") then
...
spawn(function()
 ...
 if _G.Auto_Farm_Bone1 and World3 then
 pcall(function()
  if game:GetService("Workspace").Enemies:FindFirstChild("Light Master [Lv. 1100]")  then
  for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
  if v.Name == "Light Master [Lv. 1100]"  then
  if v.Humanoid.Health > 0 then
  repeat wait()
  AutoHaki()
  EquipWeapon(_G.Select_Weapon1)
...
spawn(function()
 game:GetService("RunService").Heartbeat:Connect(function()
  pcall(function()
   for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
   if _G.Auto_Farm_Bone1 and StartMagnetBoneMon2 and (v.Name == "Darkness Master [Lv. 1100]" ) and (v.HumanoidRootPart.Position - PosMonBone.Position).magnitude <= 350 then
   v.HumanoidRootPart.CFrame = PosMonBone
   v.HumanoidRootPart.CanCollide = false
   v.HumanoidRootPart.Size = Vector3.new(50,50,50)
   if v.Humanoid:FindFirstChild("Animator") then
...
spawn(function()
 ...
 if _G.Auto_Farm_Bone1 and World3 then
 pcall(function()
  if game:GetService("Workspace").Enemies:FindFirstChild("Darkness Master [Lv. 1100]")  then
  for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
  if v.Name == "Darkness Master [Lv. 1100]"  then
  if v.Humanoid.Health > 0 then
  repeat wait()
  AutoHaki()
  EquipWeapon(_G.Select_Weapon1)
...
_G.DistanceMob = 15
Setting:Slider("Farm Distance",1,100,10,function(value)
 _G.DistanceMob = value
 end)
else
 _G.DistanceMob = 15
Setting:Slider1("Farm Distance",1,100,10,function(value)
 _G.DistanceMob = value
 end)
end
...
Main:Toggle("Màn Hình Treo Farm [ Mượt Hơn ]",_G.WhiteScreen,function(value)
 ...
 game:GetService("RunService"):Set3dRenderingEnabled(true)
   ...
   Main:Button("Giảm Lag",function()
...
function MaterialMon()
			...
			elseif _G.SelectMaterial == "Sắt Vụn" then
				if game.PlaceId == 2753915549 then
					MMon = "Brute [Lv. 45]"
...
Main:Seperator("Nguyên Liệu")
 ...
 local SelectMaterial = Main:Dropdown("Chọn Nguyên Liệu",MaterialMethod,function(value)
 _G.SelectMaterial = value
end)

Main:Toggle("Farm Nguyên Liệu Đã Chọn",_G.AutoFarmMaterial,function(t)
...
Main:Toggle("Nhặt Rương Nhanh",false,function(vu)
	_G.ChestBypass = vu
end)
...
Main:Toggle("Nhặt Rương Chậm",_G.Grab_Chest,function(vu)
	Grab_Chest = vu
    StopTween(Grab_Chest)
	_G.Grab_Chest = vu
end)

Main:Button("Nhặt Rương Siêu Nhanh ( Rủi Ro )",function()
...
Main:Button("Bones Đang Có", function()
...
spawn(function()
	while game:GetService("RunService").Heartbeat:wait() do
		...
		ObservationLevel:Set("Số Lần Né : "..tostring(value))
	end
end)
    
       Main:Toggle("Tự Động Cày Haki",_G.AutoObservation,function(value)
    ...
    Main:Toggle("Đổi Sever Cày Haki",_G.AutoObservation_Hop,function(value)
...
wait(1)
Notification:Notify(
   {Title = "Mango Man", Description = "Max Haki rồi cày j nữa ba"},
...
StopTween(_G.Auto_Elite_Hunter)
 ...
 _G.Auto_Elite_Hunter_Hop = value
	...
	Weapon:Seperator(" Katakuri Boss ")
local  Mob_Kill_Cake_Prince  = Weapon:Label("Total")
Weapon:Toggle( "Spawm Katakuri + Check Katakuri" ,_G.Auto_Cake_Pr1ince,function(value)
...
Weapon:Toggle("Farm Katakuri",_G.Auto_Cake_Prince,function(value)
...
StopTween(_G.Auto_Cake_Prince)
	...
	Weapon:Toggle("Farm Katakuri V2",_G.Auto_Open_Dough_Dungeon,function(value)
...
Weapon:Toggle("Auto Lấy Song Kiếm )",_G.AutoCdk,function(value)
 _G.AutoCdk = value
 _G.click = value
end)
...
Weapon:Toggle("Nhiệm Vụ Qua Sea3",_G.Auto_Bartilo_Quest,function(value)
 _G.Auto_Bartilo_Quest = value
StopTween(_G.Auto_Bartilo_Quest)
end)

Weapon:Seperator(" Tộc V2 ")

Weapon:Toggle("Tự động Lấy Tộc v2",_G.Auto_Evo_Race_V2,function(value)
...
for _,v in next, workspace:GetDescendants() do
  ...
  Race:Toggle("Win Ải All Tộc ( No Cá )",_G.winv4,function(value)
 _G.winv4 = value
 StopTween(_G.winv4)
end)
spawn(function()
...
Race:Toggle("Kill Người Chơi ( Có Thể Bị Kick )",nil,function(value)
...
spawn(function()
 ...
 --Teleport:Button("Teleport Quái Vật Biển",function()
 -- for i,v in pairs(game:GetService("Workspace").SeaBeasts:GetChildren()) do
--  if v:FindFirstChild("HumanoidRootPart") then
...
Op:Label("Tộc Đang Xài : "..game:GetService("Players").LocalPlayer.Data.Race.Value)

Op:Label("Fruit Đang Xài: "..game.Players.LocalPlayer.Data.DevilFruit.Value)
